...
@app('/counter2', mode = 'multicast')   # @app is a decorator that takes one required argument - the route to listen to, in this case /counter, then we'll add a multicast mode argument to syhcnronize the app across multiple users
